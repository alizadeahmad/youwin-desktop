        ...
        <div class="row">
            <div class="col products-box mt-8">
                ...
                <div class="row mt-8">
                    ...
                    <div class="col-6">
                        <div class="row">
                            <div class="col"><a-input label="نام" required/></div>
                            <div class="col"><a-input label="نام خانوادگی" required/></div>
                        </div>
                        <div class="row">
                            <div class="col"><a-input label="کد معرف" required/></div>
                            <div class="col a-select-wrapper">
                              <label>استان</label>
                              <select>
                                <option>-</option>
                                <option>تهران</option>
                        ...
                        <div class="row">
                            ...
                            <div class="col"><a-input label="عنوان آدرس" required/></div>
                        </div>
                        <div class="row">
                            <div class="col"><a-input label="آدرس کامل" required/></div>
                        </div>
                        <div class="row">
                            <div class="col-12 fs-11">انتخاب آدرس روی نقشه</div>
                            <div class="col-12">
